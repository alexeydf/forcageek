...
'ALICE NO PAIS DAS MARAVILHAS','AVATAR','CIRCULO DE FOGO','CONAN O BARBARO','DEBI E LOIDE',
'ACE VENTURA','O MASKARA','AS BRANQUELAS','UM PARTO DE VIAGEM','SUPERBAD','AMERICAN PIE',
'O TIGRE E O DRAGAO','DURO DE MATAR','SCARFACE','O PODEROSO CHEFAO','FORREST GUMP','GLADIADOR',
...
'MACGYVER','BREAKING BAD','SUPERNATURAL','AGENTES DA SHIELD','DARK','SHERLOCK',
'MODERN FAMILY','FAMILIA DINOSSAURO','DR HOUSE','PRISON BREAK','SONS OF ANARCHY','GREYS ANATOMY',
'TOW AND A HALF MEN','THE OFFICE','AMERICAN HORROR STORY'];
